...
Version  : 0.6.4
Release  : 5
URL      : https://files.pythonhosted.org/packages/ca/9b/8b2fc38bda31a3e35db69b60f7227e6ee0a6b09f78a70f7c55bd74d80209/pyroute2.ipset-0.6.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/ca/9b/8b2fc38bda31a3e35db69b60f7227e6ee0a6b09f78a70f7c55bd74d80209/pyroute2.ipset-0.6.4.tar.gz
...
%prep
%setup -q -n pyroute2.ipset-0.6.4
cd %{_builddir}/pyroute2.ipset-0.6.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1623080410
...
cp %{_builddir}/pyroute2.ipset-0.6.4/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pyroute2.ipset/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.ipset-0.6.4/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pyroute2.ipset/4cc77b90af91e615a64ae04893fdffa7939db84c
